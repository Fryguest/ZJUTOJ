...
<input class="form-control search-query" type='text' name='id'  placeholder="题目序号">
<button class="form-control" type='submit' >前往</button></form>
</td>
<td  colspan='1'>
<form class="form-search form-inline">
<input type="text" name=search class="form-control search-query" placeholder="标题关键字或来源">

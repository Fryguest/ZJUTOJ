...
#	judge.conf 
#	zjutoj/web/include/db_info.inc.php
#	and down here
...
cd ../..
#install web and db
sudo rm -r $WEBBASE/JudgeOnline
sudo cp -R zjutoj/web $WEBBASE/JudgeOnline
...
sed $SED_CMD zjutoj/web/include/db_info.inc.php|sed $SED_CMD2 >$WEBBASE/JudgeOnline/include/db_info.inc.php
